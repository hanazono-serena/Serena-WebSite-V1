<template>
    <div>
        <div class="wrapper">
            <div class="work_item" v-for="(item,i) in works" :key="i">
                <div class="work_image_container" :style="{backgroundImage:'url('+item.image+')'}"
                     v-on:click="display_modal(i)"></div>
...
<script>
    export default {
        ...
        methods: {
            display_modal(i) {
                this.modal_content = this.works[i]
                this.modal = true
            }
        }
    }
